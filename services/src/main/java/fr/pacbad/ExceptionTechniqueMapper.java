...
public class ExceptionTechniqueMapper implements ExceptionMapper<Throwable> {
	...
	public Response toResponse(final Throwable ex) {
		...
		return Response.status(Status.INTERNAL_SERVER_ERROR).entity(new ExceptionObject(ex))
	...
	private static class ExceptionObject {
		...
		public ExceptionObject(final Throwable t) {
